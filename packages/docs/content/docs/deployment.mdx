...
The fastest path is the Deploy button in the [repository README](https://github.com/fasoal-org/kafuo-teaching-engine). Fork the repository and enter an API key for at least one LLM when prompted.
